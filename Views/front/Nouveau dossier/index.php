               ...
               <!-- <a class="navbar-brand" href="#page-top">Start Bootstrap</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="./View/afficherevenement.php">evenement</a></li>
                        <li class="nav-item"><a class="nav-link" href="./View/afficherreservation.php">Reservation</a></li>
