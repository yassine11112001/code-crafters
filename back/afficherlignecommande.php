...
<?php
	...
	$listecommande=$Ligne_CommandeC->afficheligne_commande(); 
...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		<center><h1>Liste des Ligne_CommandeC</h1></center>
		<div class="row">
		...
		<div class="table-responsive">
			...
			<?php
				foreach($listecommande as $lignecommande){
			?>
			<tr>
				<td><?php echo $lignecommande['id_comm']; ?></td>
				<td><?php echo $lignecommande['id_produit']; ?></td>
				...
				<td>
					<a href="supprimerlignecommande.php?id=<?php echo $lignecommande['id_comm']; ?>&idp=<?php echo $lignecommande['id_produit']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
