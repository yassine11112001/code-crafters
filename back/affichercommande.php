...
<?php
	...
	$listecommande=$CommandeC->affichecommande(); 
...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		<center><h1>Liste des commande</h1></center>
		<div class="row">
		...
		<div class="table-responsive">
			...
			<tr>
				...
				<td>
					<a href="ajouterlivraison.php?id=<?php echo $commande['id']; ?>">passer livraison</a>
				</td>
