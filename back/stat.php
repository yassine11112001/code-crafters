...
<?php
	...
	$Ligne_Commande=new Ligne_commandeC();
    $CommandeC=new CommandeC();

	$Ligne_Commandes=$Ligne_Commande->count(); 
    $CommandeCs=$CommandeC->count();
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['commande', 'produit per commande'],
          ['commands',     <?php echo $CommandeCs["nb"];   ?>],
          ['lignecommande',  <?php echo $Ligne_Commandes["nb"];   ?>]
        ]);

        var options = {
          title: 'produit per commande'
        };
