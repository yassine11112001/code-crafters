...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <button><a href="afficherproduit.php">Retour à la afficher produit</a></button>
        <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" placeholder="Votre nom" value="<?php echo $Produit['nom']; ?>" id="nom" class="form-control" name="nom" >
