...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		<center><h1>Liste des Livraison</h1></center>
		<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>

		<input type="text" id="search" placeholder="Search...">
			<script> 
		$(document).ready(function() {
			var isSearching = false; // Indicateur pour éviter les demandes en double

  $('#search').on('input', function() {
	if (isSearching) return; // Exit if already searching
    ...
    $.ajax({
      ...
      success: function(data) {
		console.log('Received search results:', data); // Debugging statement
		...
		<div class="table-responsive">
			...
			<tr>
				...
				<td><?php echo $livraison['description']; ?></td>
