...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item ">
                <a class="nav-link" href="affichagearticle.php">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                    <thead>
             <form method="POST" action="affichagearticle.php">
    ...
    foreach($listeC as $article){
        ?>
              ...
              <tr>
                ...
                <td><?php echo $article['numtel']; ?></td>
                <td><?php echo $article['adresse']; ?></td>
               
                <td><a href="supprimerarticle.php?id=<?php echo $article['id']; ?>" class="ico del">Delete</a> </td>
                <td> <a href="modifierarticle.php?id=<?php echo $article['id']; ?>" class="ico edit">Edit</a>
